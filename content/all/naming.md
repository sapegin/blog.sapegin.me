...
(See [Avoid loops](/all/avoid-loops/) chapter for more examples.)
...
(See a larger example in the “Avoid Pascal style variables” section in the [Avoid reassigning variables](/all/avoid-reassigning-variables/) chapter.)
